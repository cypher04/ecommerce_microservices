...
# resource "azurerm_network_security_group" "agc_nsg" {
#   name                = "${var.resource_group_name}-agc-nsg"
#   location            = var.location
#   resource_group_name = var.resource_group_name
...
# resource "azurerm_subnet_network_security_group_association" "agc_nsg_assoc" {
#   subnet_id                 = var.subnet_ids["agc"]
#   network_security_group_id = azurerm_network_security_group.agc_nsg.id
# }
...
#   source_address_prefixes      = [var.subnet_prefixes["agc"]]
#   destination_address_prefixes = [var.subnet_prefixes["aks"]]
#   network_security_group_name = azurerm_network_security_group.agc_nsg.name
  
# }

# resource "azurerm_network_security_rule" "allow_appgw_health_probes" {
#   name                        = "Allow_AGC_Health_Probes"
#   resource_group_name         = var.resource_group_name
#   priority                    = 100
#   direction                   = "Inbound"
#   access                      = "Allow"
...
#   // destination_address_prefixes = [var.subnet_prefixes["web"]]
